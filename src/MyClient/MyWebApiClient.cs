...
namespace MyWeb.Client
{
    ...
    public partial class MyWebApiClient 
    {
        ...
        public virtual System.Threading.Tasks.Task UploadAsync(FileParameter file, string description, string category, System.DateTimeOffset? uploadDate, System.Collections.Generic.IDictionary<string, string> metadata)
        {
            return UploadAsync(file, description, category, uploadDate, metadata, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task UploadAsync(FileParameter file, string description, string category, System.DateTimeOffset? uploadDate, System.Collections.Generic.IDictionary<string, string> metadata, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (uploadDate == null)
                        throw new System.ArgumentNullException("uploadDate");
                    else
                    {
                        content_.Add(new System.Net.Http.StringContent(ConvertToString(uploadDate, System.Globalization.CultureInfo.InvariantCulture)), "UploadDate");
                    }
                    ...
                    {
                        var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(metadata, _settings.Value);
